    ...
    >
      <div className="mx-auto max-w-[1140px] px-8">
        ...
        <AccordionPrimitive.Root
          ...
          ref={itemRef}
        >
          <AccordionPrimitive.Item value="why-we-exist" className="group">
            <AccordionPrimitive.Header className="flex">
              <AccordionPrimitive.Trigger className="flex w-full items-center gap-5 py-[26px] text-left transition-[padding-left] duration-250 hover:pl-[14px] focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-ink">
